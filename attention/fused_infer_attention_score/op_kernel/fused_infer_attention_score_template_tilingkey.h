...
ASCENDC_TPL_ARGS_DECL(FusedInferAttentionScore,
    ...
    ASCENDC_TPL_UINT_DECL(M_K_QUANTMODE_P_NEWTILINGFLAH_I_AMLA, ASCENDC_TPL_4_BW, ASCENDC_TPL_UI_LIST, 0, 1, 2, 3, 4, 5, 6, 8),
    ...
    ASCENDC_TPL_UINT_DECL(P_CVDIFF_BASE_FLAG, ASCENDC_TPL_2_BW, ASCENDC_TPL_UI_LIST, 0, 1, 2),
...
ASCENDC_TPL_SEL(
    ASCENDC_TPL_ARGS_SEL(
        ASCENDC_TPL_UINT_SEL(Q_T, ASCENDC_TPL_UI_LIST, 0, 2),
        ASCENDC_TPL_UINT_SEL(KV_T, ASCENDC_TPL_UI_LIST, 0, 2),
        ASCENDC_TPL_UINT_SEL(OUT_T, ASCENDC_TPL_UI_LIST, 0, 2),
        ASCENDC_TPL_BOOL_SEL(PAGE_ATTENTIOND, ASCENDC_TPL_UI_LIST,1),
        ASCENDC_TPL_UINT_SEL(LAYOUT_T, ASCENDC_TPL_UI_LIST, 0, 1, 3),
        ASCENDC_TPL_UINT_SEL(KV_LAYOUT_T, ASCENDC_TPL_UI_LIST, 0, 1, 2),
        ASCENDC_TPL_BOOL_SEL(FLASH_DECODE, ASCENDC_TPL_UI_LIST, 0, 1),
        ASCENDC_TPL_BOOL_SEL(ENABLE_PREFIX, ASCENDC_TPL_UI_LIST, 0),
        ...
        ASCENDC_TPL_UINT_DECL(P_CVDIFF_BASE_FLAG, ASCENDC_TPL_2_BW, ASCENDC_TPL_UI_LIST, 0),
        ASCENDC_TPL_UINT_DECL(P_CVDIFF_MLA_FLAG, ASCENDC_TPL_1_BW, ASCENDC_TPL_UI_LIST, 0),
        ASCENDC_TPL_UINT_DECL(P_TEMPLATE_VERSION, ASCENDC_TPL_3_BW, ASCENDC_TPL_UI_LIST, 0),
        ASCENDC_TPL_UINT_DECL(TEMPLATE_MODE, ASCENDC_TPL_2_BW, ASCENDC_TPL_UI_LIST, 0)
