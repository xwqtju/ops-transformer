...
extern "C" __global__ __aicore__ void mla_prolog_v3(
    ...
    // MlaPrologV3<inputType1, inputType2, input3Type3, CACHE_MODE>
    ...
    TILING_KEY_IS(10000000000100012);
        ...
        INVOKE_MLA_PROLOG_V3_NO_KFC_OP_IMPL(MlaPrologVecS1CubS2, bfloat16_t, bfloat16_t, bfloat16_t,
    ...
    TILING_KEY_IS(10000000000101022);
        ...
        INVOKE_MLA_PROLOG_V3_NO_KFC_OP_IMPL(MlaPrologVecS1CubS2, bfloat16_t, int8_t, bfloat16_t,
                                         CACHE_MODE::PA_BSND, false, false, EMPTY_TENSOR_MODE::NON_EMPTY);
    ...
    TILING_KEY_IS(10000000000101122);
        ...
        INVOKE_MLA_PROLOG_V3_NO_KFC_OP_IMPL(MlaPrologVecS1CubS2, bfloat16_t, int8_t, int8_t,
                                         CACHE_MODE::PA_BSND, false, false, EMPTY_TENSOR_MODE::NON_EMPTY);
    ...
    TILING_KEY_IS(10000000000101222);
        ...
        INVOKE_MLA_PROLOG_V3_NO_KFC_OP_IMPL(MlaPrologVecS1CubS2, int8_t, int8_t, bfloat16_t,
                                         CACHE_MODE::PA_BSND, false, false, EMPTY_TENSOR_MODE::NON_EMPTY);
    ...
    TILING_KEY_IS(10000000000101322);
        ...
        INVOKE_MLA_PROLOG_V3_NO_KFC_OP_IMPL(MlaPrologVecS1CubS2, int8_t, int8_t, int8_t,
                                         CACHE_MODE::PA_BSND, false, false, EMPTY_TENSOR_MODE::NON_EMPTY);
