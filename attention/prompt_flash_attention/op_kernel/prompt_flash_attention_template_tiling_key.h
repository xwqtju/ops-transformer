...
ASCENDC_TPL_ARGS_DECL(PromptAttention,
  // bit 0, tail mode
  ASCENDC_TPL_UINT_DECL(M_OUTLAYOUT_P_TAIL_MODE_I_ORIGIN_T, ASCENDC_TPL_5_BW, ASCENDC_TPL_UI_LIST, 0, 1, 2, 3, 4, 5, 6, 7, 8),

  // bit 1
  // 0: old tiling
  // 1: new tiling
  ASCENDC_TPL_UINT_DECL(M_K_QUANTMODE_P_NEWTILINGFLAH_I_AMLA, ASCENDC_TPL_4_BW, ASCENDC_TPL_UI_LIST, 0, 1, 2, 3, 4, 5, 6, 7, 8),
  ...
  // 7: fp4_e2m1
  // 8: fp4_e1m2
  ASCENDC_TPL_UINT_DECL(Q_T, ASCENDC_TPL_5_BW, ASCENDC_TPL_UI_LIST, 0, 1, 2, 3, 4, 5, 6, 7, 8),

  // bit 3
  // 0: 高性能
  // 1: 高精度
  ASCENDC_TPL_UINT_DECL(M_V_QUANTMODE_P_PRECISION_MODE_I_BALANCE, ASCENDC_TPL_4_BW, ASCENDC_TPL_UI_LIST, 0, 1, 2),
  ...
  // 0: BNSD
  // 1: BSH
  ASCENDC_TPL_UINT_DECL(LAYOUT_T, ASCENDC_TPL_4_BW, ASCENDC_TPL_UI_LIST, 0, 1, 2, 3, 4, 5),

  // bit 6
  // 0: MDL
  // 1: NORMAL
  // 2: MM_IBSHARE_NORMAL
  ASCENDC_TPL_UINT_DECL(M_FIAFLAG_P_MMTYPETMP_I_MODEVAL, ASCENDC_TPL_4_BW, ASCENDC_TPL_UI_LIST, 0, 1, 2, 3, 4),

  // bit 7
  // 0: 不使能PA
  // 1: 使能PA_ND
  // 2: 使能PA_NZ
  ASCENDC_TPL_UINT_DECL(PAGE_ATTENTIOND, ASCENDC_TPL_4_BW, ASCENDC_TPL_UI_LIST, 0, 1, 2),
  ...
  // 0: 不使能msd
  // 1: 使能msd
  ASCENDC_TPL_UINT_DECL(M_Q_QUANTMODE_P_MSD_MODE_I_ANTIQUANTMODE, ASCENDC_TPL_4_BW, ASCENDC_TPL_UI_LIST, 0, 1, 2, 3, 4),

  // bit 9
  // 0: 不使能CVDIFF_BASE模板
  // 1: 使能CVDIFF_BASE模板
  ASCENDC_TPL_UINT_DECL(P_CVDIFF_BASE_FLAG, ASCENDC_TPL_4_BW, ASCENDC_TPL_UI_LIST, 0, 1, 2),

  // bit 10
  // 0: 不使能CVDIFF_MLA模板
  // 1: 使能CVDIFF_MLA模板
  ASCENDC_TPL_UINT_DECL(P_CVDIFF_MLA_FLAG, ASCENDC_TPL_4_BW, ASCENDC_TPL_UI_LIST, 0, 1),
  ...
  // 2: 基础API高精度
  // 3: 基础API SAMEAB
  ASCENDC_TPL_UINT_DECL(P_TEMPLATE_VERSION, ASCENDC_TPL_4_BW, ASCENDC_TPL_UI_LIST, 0, 1, 2, 3, 4)

  ASCENDC_TPL_UINT_DECL(KV_LAYOUT_T, ASCENDC_TPL_4_BW, ASCENDC_TPL_UI_LIST, 0, 1)

  ASCENDC_TPL_UINT_DECL(FLASH_DECODE, ASCENDC_TPL_4_BW, ASCENDC_TPL_UI_LIST, 0, 1)
);
    ...
    ASCENDC_TPL_SEL(        // TILING_KEY_VAR == 1000000000000000010
        ...
        ASCENDC_TPL_UINT_SEL(M_K_QUANTMODE_P_NEWTILINGFLAH_I_AMLA, ASCENDC_TPL_UI_LIST, 1),
...
//******** 
    ...
    ASCENDC_TPL_ARGS_SEL(     // TILING_KEY_VAR == 4000000000000000000
        ...
        ASCENDC_TPL_UINT_SEL(M_Q_QUANTMODE_P_MSD_MODE_I_ANTIQUANTMODE, ASCENDC_TPL_UI_LIST, 0),
        ASCENDC_TPL_UINT_SEL(M_OUTLAYOUT_P_TAIL_MODE_I_ORIGIN_T, ASCENDC_TPL_UI_LIST, 0),
        ASCENDC_TPL_UINT_SEL(M_K_QUANTMODE_P_NEWTILINGFLAH_I_AMLA, ASCENDC_TPL_UI_LIST, 0),
        ASCENDC_TPL_UINT_SEL(M_V_QUANTMODE_P_PRECISION_MODE_I_BALANCE, ASCENDC_TPL_UI_LIST, 0),
        ASCENDC_TPL_UINT_SEL(M_FIAFLAG_P_MMTYPETMP_I_MODEVAL, ASCENDC_TPL_UI_LIST, 0),
        ASCENDC_TPL_UINT_SEL(P_CVDIFF_BASE_FLAG, ASCENDC_TPL_UI_LIST, 0),
        ASCENDC_TPL_UINT_SEL(P_CVDIFF_MLA_FLAG, ASCENDC_TPL_UI_LIST, 0),
    ...
    ASCENDC_TPL_ARGS_SEL( // TILING_KEY_VAR == 1000000000000000020
        ...
        ASCENDC_TPL_UINT_SEL(M_Q_QUANTMODE_P_MSD_MODE_I_ANTIQUANTMODE, ASCENDC_TPL_UI_LIST, 0),
        ASCENDC_TPL_UINT_SEL(M_OUTLAYOUT_P_TAIL_MODE_I_ORIGIN_T, ASCENDC_TPL_UI_LIST, 0),
        ASCENDC_TPL_UINT_SEL(M_K_QUANTMODE_P_NEWTILINGFLAH_I_AMLA, ASCENDC_TPL_UI_LIST, 2),
        ASCENDC_TPL_UINT_SEL(M_V_QUANTMODE_P_PRECISION_MODE_I_BALANCE, ASCENDC_TPL_UI_LIST, 0),
        ASCENDC_TPL_UINT_SEL(M_FIAFLAG_P_MMTYPETMP_I_MODEVAL, ASCENDC_TPL_UI_LIST, 0),
        ASCENDC_TPL_UINT_SEL(P_CVDIFF_BASE_FLAG, ASCENDC_TPL_UI_LIST, 0),
        ASCENDC_TPL_UINT_SEL(P_CVDIFF_MLA_FLAG, ASCENDC_TPL_UI_LIST, 0),
    ...
    ASCENDC_TPL_ARGS_SEL( // TILING_KEY_VAR == 1000000000000112288
        ...
        ASCENDC_TPL_UINT_SEL(M_K_QUANTMODE_P_NEWTILINGFLAH_I_AMLA, ASCENDC_TPL_UI_LIST, 8),
