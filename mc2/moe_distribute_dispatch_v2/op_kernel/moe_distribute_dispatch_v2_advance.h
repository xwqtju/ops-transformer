...
/*!
 * \file moe_distribute_dispatch_v2_advance.h
 * \brief
 */
#ifndef MOE_DISTRIBUTE_DISPATCH_V2_ADVANCE_H
#define MOE_DISTRIBUTE_DISPATCH_V2_ADVANCE_H
...
namespace MoeDistributeDispatchV2AdvanceImpl {
...
class MoeDistributeDispatchV2Advance {
public:
    __aicore__ inline MoeDistributeDispatchV2Advance() {};
...
template <TemplateMC2TypeClass>
__aicore__ inline void MoeDistributeDispatchV2Advance<TemplateMC2TypeFunc>::InitElasticInfo(GM_ADDR elasticInfo, const MoeDistributeDispatchV2TilingData *tilingData)
{
...
template <TemplateMC2TypeClass>
__aicore__ inline void MoeDistributeDispatchV2Advance<TemplateMC2TypeFunc>::Init(
...
template <TemplateMC2TypeClass>
__aicore__ inline void MoeDistributeDispatchV2Advance<TemplateMC2TypeFunc>::QuantInit(GM_ADDR scales)
{
...
template <TemplateMC2TypeClass>
__aicore__ inline void MoeDistributeDispatchV2Advance<TemplateMC2TypeFunc>::SplitToCore(
...
template <TemplateMC2TypeClass>
__aicore__ inline void MoeDistributeDispatchV2Advance<TemplateMC2TypeFunc>::FillTriple(
...
template <TemplateMC2TypeClass>
__aicore__ inline void MoeDistributeDispatchV2Advance<TemplateMC2TypeFunc>::SendToSharedExpert()
{
...
template <TemplateMC2TypeClass>
__aicore__ inline void MoeDistributeDispatchV2Advance<TemplateMC2TypeFunc>::CalTokenSendExpertCnt(
...
template <TemplateMC2TypeClass>
__aicore__ inline void MoeDistributeDispatchV2Advance<TemplateMC2TypeFunc>::SendToMoeExpert()
{
    uint32_t startTokenId, endTokenId, sendTokenNum; // 每个aiv发送时的起始rankid
...
template <TemplateMC2TypeClass>
__aicore__ inline void MoeDistributeDispatchV2Advance<TemplateMC2TypeFunc>::TokenActiveMaskCal()
{
...
template <TemplateMC2TypeClass>
__aicore__ inline void MoeDistributeDispatchV2Advance<TemplateMC2TypeFunc>::CalValidExpIdx(LocalTensor<bool> maskInputTensor)
{
...
template <TemplateMC2TypeClass>
__aicore__ inline void MoeDistributeDispatchV2Advance<TemplateMC2TypeFunc>::CalValidBSCnt(LocalTensor<bool> maskStrideTensor)
{
    uint64_t rsvdCnt = 0;
...
template <TemplateMC2TypeClass>
__aicore__ inline void MoeDistributeDispatchV2Advance<TemplateMC2TypeFunc>::ExpertActiveMaskCal()
{
...
template <TemplateMC2TypeClass>
__aicore__ inline void MoeDistributeDispatchV2Advance<TemplateMC2TypeFunc>::MaskZeroComputeExpert(uint32_t maskCnt)
{
...
template <TemplateMC2TypeClass>
__aicore__ inline void MoeDistributeDispatchV2Advance<TemplateMC2TypeFunc>::GenerateGatherMaskTensor(uint32_t maskCnt)
{
...
template <TemplateMC2TypeClass>
__aicore__ inline void MoeDistributeDispatchV2Advance<TemplateMC2TypeFunc>::ZeroComputeExpertMaskCal()
{
...
*/
template <TemplateMC2TypeClass>
__aicore__ inline void MoeDistributeDispatchV2Advance<TemplateMC2TypeFunc>::AlltoAllDispatch()
{
...
template <TemplateMC2TypeClass>
__aicore__ inline void MoeDistributeDispatchV2Advance<TemplateMC2TypeFunc>::SetStatus()
{
...
template <TemplateMC2TypeClass>
__aicore__ inline void MoeDistributeDispatchV2Advance<TemplateMC2TypeFunc>::ReduceMaxInplace(const LocalTensor<float>& srcLocal,
    uint32_t count)
{
...
template <TemplateMC2TypeClass>
__aicore__ inline void MoeDistributeDispatchV2Advance<TemplateMC2TypeFunc>::QuantProcess(uint32_t expertIndex)
{
...
template <TemplateMC2TypeClass>
__aicore__ inline void MoeDistributeDispatchV2Advance<TemplateMC2TypeFunc>::SyncCntOnCore(
...
template <TemplateMC2TypeClass>
__aicore__ inline void MoeDistributeDispatchV2Advance<TemplateMC2TypeFunc>::BufferInit()
{
    tpipe_->Reset();
...
template <TemplateMC2TypeClass>
__aicore__ inline void MoeDistributeDispatchV2Advance<TemplateMC2TypeFunc>::WaitDispatch()
{
    BufferInit();
...
template <TemplateMC2TypeClass>
__aicore__ inline void MoeDistributeDispatchV2Advance<TemplateMC2TypeFunc>::GetCumSum(LocalTensor<int32_t> &outLocal, uint32_t totalCount)
{
...
template <TemplateMC2TypeClass>
__aicore__ inline void MoeDistributeDispatchV2Advance<TemplateMC2TypeFunc>::LocalWindowCopy()
{
...
template <TemplateMC2TypeClass>
__aicore__ inline void MoeDistributeDispatchV2Advance<TemplateMC2TypeFunc>::AllGatherSetStatusAndWait()
{
    PipeBarrier<PIPE_ALL>();
...
template <TemplateMC2TypeClass>
__aicore__ inline void MoeDistributeDispatchV2Advance<TemplateMC2TypeFunc>::AllgatherProcessOut()
{
    if (startExpertId_ >= totalExpertNum_) {
        return;
    }
...
template <TemplateMC2TypeClass>
__aicore__ inline void MoeDistributeDispatchV2Advance<TemplateMC2TypeFunc>::UpdataTokenNumsOut()
{
...
template <TemplateMC2TypeClass>
__aicore__ inline void MoeDistributeDispatchV2Advance<TemplateMC2TypeFunc>::Process()
{
...
} // MoeDistributeDispatchV2AdvanceImpl
#endif // MOE_DISTRIBUTE_DISPATCH_V2_ADVANCE_H