 ...
 * @param [in] x1: add左矩阵，数据类型支持：float16, bf16。
 * @param [in] x2: add右矩阵，数据类型支持：float16, bf16。
 ...
 */
ACLNN_API aclnnStatus aclnnAllGatherAddGetWorkspaceSize(const aclTensor* x1, const aclTensor* x2,
