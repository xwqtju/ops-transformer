...
class AllGatherAddBase {
public:
    __aicore__ inline AllGatherAddBase() {}
    ...
    __aicore__ inline void AddLocalCompute(GM_ADDR aGM, GM_ADDR cGM);
    __aicore__ inline void AddLocalComputeL2Cache(GM_ADDR aGM, GM_ADDR cGM);
    __aicore__ inline void AddKernelLocal();
...
template <class A_TYPE, class B_TYPE, class C_TYPE, class BIAS_TYPE, bool BNd2Nz, bool Bias2Float>
__aicore__ inline void AllGatherAddBase<A_TYPE, B_TYPE, C_TYPE, BIAS_TYPE, BNd2Nz, Bias2Float>::InitBase(GM_ADDR aGM,
...
template <class A_TYPE, class B_TYPE, class C_TYPE, class BIAS_TYPE, bool BNd2Nz, bool Bias2Float>
__aicore__ inline void AllGatherAddBase<A_TYPE, B_TYPE, C_TYPE, BIAS_TYPE, BNd2Nz, Bias2Float>::Nd2NzBiasCast()
{
...
template <class A_TYPE, class B_TYPE, class C_TYPE, class BIAS_TYPE, bool BNd2Nz, bool Bias2Float>
__aicore__ inline void AllGatherAddBase<A_TYPE, B_TYPE, C_TYPE, BIAS_TYPE, BNd2Nz, Bias2Float>::AddLocalCompute(
    GM_ADDR aGM, GM_ADDR cGM)
{
    auto &&tiling = tilingData_->localTiling;
    auto &&cfg = tilingData_->param;

    AddCompute<A_TYPE, B_TYPE, C_TYPE, BIAS_TYPE, SplitType::DEFAULT> mm;
    // Add的一次计算流程
...
AllGatherAddBase<A_TYPE, B_TYPE, C_TYPE, BIAS_TYPE, BNd2Nz, Bias2Float>::AddLocalComputeL2Cache(GM_ADDR aGM,
    GM_ADDR cGM)
{
    auto &&tiling = tilingData_->localTiling;
    auto &&cfg = tilingData_->param;

    AddCompute<A_TYPE, B_TYPE, C_TYPE, BIAS_TYPE, SplitType::L2CACHE> mm;
    // Add的一次计算流程
    mm.Init(cfg, tiling, tilingData_->localL2Tiling, rankId_);
...
template <class A_TYPE, class B_TYPE, class C_TYPE, class BIAS_TYPE, bool BNd2Nz, bool Bias2Float>
__aicore__ inline void AllGatherAddBase<A_TYPE, B_TYPE, C_TYPE, BIAS_TYPE, BNd2Nz, Bias2Float>::AddKernelLocal()
{
    auto &&tiling = tilingData_->localTiling;
    ...
    if (l2Tiling.enableL2Tile > 0) {
        AddLocalComputeL2Cache(aLocalGM, cGM_);
    } else {
        AddLocalCompute(aLocalGM, cGM_);
    }
}
}
#endif