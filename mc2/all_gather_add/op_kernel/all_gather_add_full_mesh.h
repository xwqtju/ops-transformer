...
class AllGatherAddFullMesh : public AllGatherAddBase<A_TYPE, B_TYPE, C_TYPE, BIAS_TYPE, BNd2Nz, Bias2Float> {
public:
    __aicore__ inline AllGatherAddFullMesh() {}
    __aicore__ inline void Init(GM_ADDR aGM, GM_ADDR bGM, GM_ADDR biasGM, GM_ADDR cGM, GM_ADDR gatherGM,
        GM_ADDR workspaceGM, GM_ADDR contextGM, AllGatherAddTilingData *tilingData, __gm__ void* mc2InitTiling,
...
private:
    ...
    __aicore__ inline void AddKernelCompute(GM_ADDR aGM, GM_ADDR cGM, TCubeTiling &tiling, TileL2Tiling &l2Tiling,
        HcclHandle &handleId, uint32_t tileCnt);
    __aicore__ inline void AddKernelComputeL2Cache(GM_ADDR aGM, GM_ADDR cGM, TCubeTiling &tiling,
        TileL2Tiling &l2Tiling, HcclHandle &handleId, uint32_t tileCnt);
    __aicore__ inline void AddKernelGather(GM_ADDR aGM, GM_ADDR cGM, TCubeTiling &tiling, TileL2Tiling &l2Tiling,
        HcclHandle &handleId, uint32_t tileCnt);
...
template <class A_TYPE, class B_TYPE, class C_TYPE, class BIAS_TYPE, bool BNd2Nz, bool Bias2Float>
__aicore__ inline void AllGatherAddFullMesh<A_TYPE, B_TYPE, C_TYPE, BIAS_TYPE, BNd2Nz, Bias2Float>::Init(GM_ADDR aGM,
    GM_ADDR bGM, GM_ADDR biasGM, GM_ADDR cGM, GM_ADDR gatherGM, GM_ADDR workspaceGM, GM_ADDR contextGM,
    AllGatherAddTilingData *tilingData, __gm__ void* mc2InitTiling, __gm__ void* mc2CcTiling, TPipe *tPipe)
{
...
template <class A_TYPE, class B_TYPE, class C_TYPE, class BIAS_TYPE, bool BNd2Nz, bool Bias2Float>
__aicore__ inline void AllGatherAddFullMesh<A_TYPE, B_TYPE, C_TYPE, BIAS_TYPE, BNd2Nz, Bias2Float>::Process()
{
    HcclPrepare();
    this->Nd2NzBiasCast();
    InnerProcess();
...
template <class A_TYPE, class B_TYPE, class C_TYPE, class BIAS_TYPE, bool BNd2Nz, bool Bias2Float>
__aicore__ inline void AllGatherAddFullMesh<A_TYPE, B_TYPE, C_TYPE, BIAS_TYPE, BNd2Nz, Bias2Float>::HcclPrepare()
{
    if ASCEND_IS_AIC {
...
template <class A_TYPE, class B_TYPE, class C_TYPE, class BIAS_TYPE, bool BNd2Nz, bool Bias2Float>
__aicore__ inline void AllGatherAddFullMesh<A_TYPE, B_TYPE, C_TYPE, BIAS_TYPE, BNd2Nz, Bias2Float>::InnerProcess()
{
    if ASCEND_IS_AIC {
        auto &&cfg = this->tilingData_->param;
        // 计算本卡数据
        ...
        // 获取远端数据计算
        AddKernelGather(this->gatherGM_, this->cGM_, this->tilingData_->tileTiling, this->tilingData_->tileL2Tiling,
        ...
        if (cfg.tailCnt > 0) {
            ...
            AddKernelGather(tailGatherGM, tailCGM, this->tilingData_->tailTiling, this->tilingData_->tailL2Tiling,
...
AllGatherAddFullMesh<A_TYPE, B_TYPE, C_TYPE, BIAS_TYPE, BNd2Nz, Bias2Float>::AddKernelCompute(GM_ADDR aGM,
