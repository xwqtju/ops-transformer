    ...
    GM_ADDR tpSendCountsOut, GM_ADDR expandScalesOut, GM_ADDR workspaceGM, GM_ADDR tilingGM)
{
    ...
    if (TILING_KEY_IS(1000)) {
        ...
        op.Init(x, expertIds, scales, waitCost, xActiveMask, expandXOut, dynamicScalesOut, expandIdxOut, expertTokenNumsOut, epSendCountsOut,
        ...
        if (dataplaneMode == DataplaneMode::AICPU) {
            ...
            op.Init(x, expertIds, scales, waitCost, expertScales, expandXOut, dynamicScalesOut, expandIdxOut, expertTokenNumsOut, 
                    epSendCountsOut, expandScalesOut, workspaceGM, &pipe, tilingGM, contextGM0);
            op.Process();
        }
    }
